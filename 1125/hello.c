...
__Pyx_RefNannySetupContext("PyInit_hello", 0);
  ...
  }
  {
    ...
    if (!PyDict_GetItemString(modules, "hello")) {
      if (unlikely((PyDict_SetItemString(modules, "hello", __pyx_m) < 0))) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * 
*/
  if (__Pyx_PrintOne(0, __pyx_mstate_global->__pyx_kp_u_Hello_World) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{11},{18},{3},{4},{8},{10},{8},{5},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (84 bytes) */
const char* const cstring = "x\332%\310\301\r\2000\014\003\300U\330\204/\033\360\214Bc\244\2104\2056\335\237 \374\260\345[7\230\265eo\335\244\230:H\235\242s\301\301\345\202\313\251\006\242\312\311\231\332d~\237\310\271\346\336]=\210\236\311\366\303@\010N\236\226\032\030\331/sw'\035";
...
const char* const bytes = "?Hello Worldcline_in_tracebackendfile__main____module____name__print__qualname__setdefault__test__";
    PyObject *data = NULL;
